...
FloorfieldViaFM::~FloorfieldViaFM()
{
    ...
    if (_subroomUID) delete[] _subroomUID;
...
//#pragma omp critical
        ...
        localneggradptr = (_neggradmap.count(destID) == 0) ? nullptr : _neggradmap.at(destID); //will fail if above if-clause was entered
