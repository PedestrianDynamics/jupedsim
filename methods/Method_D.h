...
public:
	...
	const void DoseCalculateIndividualFD(bool individualFD);
	const void DoesCutByCircle(bool iscut);
	...
	const void DoseCalculateProfiles(bool calcProfile);
	const void DoesOutputVoronoiCellData(bool outputCellData);
