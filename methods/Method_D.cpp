...
const void Method_D::DoseCalculateIndividualFD(bool individualFD)
{
	_calcIndividualFD = individualFD;
}

const void Method_D::DoesCutByCircle(bool iscut)
{
...
const void Method_D::DoseCalculateProfiles(bool calcProfile)
{
	_getProfile =calcProfile;
}

const void Method_D::DoesOutputVoronoiCellData(bool outputCellData)
{
