...
data_1_filename = 'reference_data_Method_2_J.dat'
data_1 = np.loadtxt(data_1_filename)

data_2_filename = './Output_Methods_2/Fundamental_Diagram/Classical_Voronoi/rho_v_Voronoi_J_traj_Methods.txt_id_5.dat'
...
if (velocity_exit == True) and (density_exit == True):
    logging.info('Method J: Test passed successfully.')
    logging.shutdown()
    sys.exit(0)
else:
    logging.info('Method J: Test passed not successfully.')
    logging.shutdown()
    sys.exit(1)
