...
data_1_filename = 'reference_data_Method_1_C.dat'
data_1 = np.loadtxt(data_1_filename)

data_2_filename = './Output_Methods_1/Fundamental_Diagram/Classical_Voronoi/rho_v_Classic_traj_Methods.txt_id_3.dat'
