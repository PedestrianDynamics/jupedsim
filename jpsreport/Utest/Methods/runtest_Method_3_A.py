...
data_1_filename = 'reference_data_Method_3_A_Flow_NT.dat'
data_1 = np.loadtxt(data_1_filename)

data_2_filename = './Output_Methods_3/Fundamental_Diagram/FlowVelocity/Flow_NT_traj_Methods.txt_id_2.dat'
