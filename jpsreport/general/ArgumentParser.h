...
public:
    ...
    std::vector<bool> GetIndividualFDFlagsMethodD() const;
    std::vector<bool> GetIndividualFDFlagsMethodJ() const;
    bool GetIsCutByCircleMethodD() const;
    bool GetIsCutByCircleMethodI() const;
    bool GetIsCutByCircleMethodJ() const;
    double GetCutRadiusMethodD() const;
    double GetCutRadiusMethodI() const;
    double GetCutRadiusMethodJ() const;
    int GetCircleEdgesMethodD() const;
    int GetCircleEdgesMethodI() const;
    int GetCircleEdgesMethodJ() const;
    bool GetIsOutputGraph() const;
    bool GetIsOneDimensionalMethodD() const;
    bool GetIsOneDimensionalMethodI() const;
    bool GetIsOneDimensionalMethodJ() const;
    double GetSteadyStart() const;
    double GetSteadyEnd() const;
    bool GetIsGetProfileMethodD() const;
    bool GetIsGetProfileMethodI() const;
    bool GetIsGetProfileMethodJ() const;
    float GetGridSizeXMethodD() const;
    float GetGridSizeXMethodI() const;
    float GetGridSizeXMethodJ() const;
    float GetGridSizeYMethodD() const;
    float GetGridSizeYMethodI() const;
    float GetGridSizeYMethodJ() const;
    int GetLog() const;
