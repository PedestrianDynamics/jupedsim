#!/usr/bin/env python
####################
# Test global IFD data of Method D with use_blind_points enabled, cut_by_circle enabled, radius of 1 and varied number of edges
####################
...
def runtest(inifile, trajfile):
    ...
    logging.info("===== Test global IFD data of Method D with use_blind_points enabled, cut_by_circle enabled, radius of 1 and varied number of edges ===============")
