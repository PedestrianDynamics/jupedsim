#!/usr/bin/env python
####################
# Test global IFD data of Method D with one measurement area spreading over several subrooms
####################
...
def runtest(inifile, trajfile):
    ...
    logging.info("===== Test global IFD data of Method D with one measurement area spreading over several subrooms ===============")
