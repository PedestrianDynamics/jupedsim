#!/usr/bin/env python
####################
# Test of Method D with use_blind_points disabled, arithmetic velocity calculation, cut_by_circle enabled, radius of 1 and varied number of edges
####################
...
def runtest(inifile, trajfile):
    ...
    logging.info("===== Test of Method D with use_blind_points disabled, arithmetic velocity calculation, cut_by_circle enabled, radius of 1 and varied number of edges ===============")
