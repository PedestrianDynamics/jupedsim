#!/usr/bin/env python
####################
# Test profile calculation for 2 frames with Method D with use_blind_points disabled and arithmetic velocity calculation
####################
...
def runtest(inifile, trajfile):
    ...
    logging.info("===== Test profile calculation for 2 frames with Method D with use_blind_points disabled and arithmetic velocity calculation ===============")
