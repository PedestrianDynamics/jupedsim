#!/usr/bin/env python
####################
# Test of Method with use_blind_points disabled, cut_by_circle enabled and small radius of 0.5
####################
...
def runtest(inifile, trajfile):
    ...
    logging.info(
        "=====  Test of Method D with use_blind_points disabled, cut_by_circle enabled and small radius of 0.5 ===============")
