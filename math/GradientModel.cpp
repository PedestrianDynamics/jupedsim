...
GradientModel::~GradientModel(void) { }
...
void GradientModel::CalculateForce(double time, double tip1, Building* building) const
{
     double delta = 0.5;
     double h = tip1 - time;
...
string GradientModel::writeParameter() const
{
     string rueck;
     char tmp[CLENGTH];
