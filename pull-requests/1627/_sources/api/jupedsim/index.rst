...
.. py:class:: CustomOperationalModel
   ...
   .. py:method:: check_model_constraint(ped: jupedsim.agent._TransientAgent, env_query: jupedsim.environment_query.EnvironmentQuery) -> None

      Raise an exception when ``ped`` violates this model's constraints.

      :param ped: The agent to validate.
      :param env_query: Spatial query object for the current step.



   .. py:method:: compute_next_state(dt: float, ped: jupedsim.agent._TransientAgent, env_query: jupedsim.environment_query.EnvironmentQuery) -> CustomModelAgentState
      :abstractmethod:
      ...
      :param ped: The agent being updated. Only valid for the duration of this call.
      :param env_query: Spatial query object for the current step. Use it to
                        find neighboring agents and query geometry. Only valid for the
                        duration of this call.

      :returns: New agent state. Must be a new object -- returning ``ped.model``
