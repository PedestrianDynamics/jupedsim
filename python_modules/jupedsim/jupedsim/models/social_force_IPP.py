...
class SocialForceModelIPP:
    r"""Parameters for Social Force Model with Inverted Pendulum Paradigm representation for agents
    ...
    def __init__(
        ...
        *,
        ...
        """
        Init dataclass SocialForceModelIPP to handle deprecated arguments.
        """
...
class SocialForceModelIPPAgentParameters:
    """
    Parameters required to create an Agent in the Social Force Model with Inverted Pendulum Paradigm representation for agents.
