...
.. py:class:: Simulation(model, geometry: jupedsim.native.geometry.Geometry, dt: float)
   ...
   .. py:method:: add_agent(parameters: jupedsim.native.models.GCFMModelAgentParameters | jupedsim.native.models.VelocityModelAgentParameters) -> int
   ...
   .. py:method:: switch_agent_profile(agent_id: int, profile_id: int) -> None


   .. py:method:: switch_agent_journey(agent_id: int, journey_id: int, stage_index: int) -> None
