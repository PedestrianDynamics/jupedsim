...
def main():
    ...
    geo_builder.add_accessible_area([(0, 0), (10, 0), (10, 2), (0, 2)])
    ...
    # waypoints
    journey = jps.Journey.make_waypoint_journey([((9.75, 1), 0.25)])
    ...
    writer = JpsCoreStyleTrajectoryWriter(pathlib.Path("01.txt"))
