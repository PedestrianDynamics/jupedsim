...
SegmentGrid::SegmentGrid(std::vector<LineSegment> segments) : _segments(std::move(segments))
{
...
const std::vector<LineSegment>& SegmentGrid::LineSegmentsInApproxDistanceTo(Point p) const
{
...
void SegmentGrid::insertIntoApproximateGrid(const LineSegment& ls)
{
...
SegmentGrid::LineSegmentRange SegmentGrid::LineSegmentsInDistanceTo(double distance, Point p) const
{
...
bool SegmentGrid::IntersectsAny(const LineSegment& linesegment) const
{
