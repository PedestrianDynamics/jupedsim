...
double
CollisionFreeSpeedModelV2::OptimalSpeed(const State& model, double spacing, double time_gap) const
{
...
Point CollisionFreeSpeedModelV2::NeighborRepulsion(const State& model1, const State& model2) const
{
    const auto distp12 = model2.position - model1.position;
