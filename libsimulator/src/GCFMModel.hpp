...
public:
    ...
    void ApplyUpdate(const PedestrianUpdate& upate, GenericAgent& agent, Data& modelData) const;
...
private:
    ...
    Point ForceRepWall(const GenericAgent* ped, const Data& modelData, const Line& l) const;
    Point ForceRepStatPoint(
        const GenericAgent* ped,
