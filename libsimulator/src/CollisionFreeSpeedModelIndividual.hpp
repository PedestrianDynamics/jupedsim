...
class CollisionFreeSpeedModelIndividual : public OperationalModel
{
public:
...
public:
    CollisionFreeSpeedModelIndividual() = default;
    ~CollisionFreeSpeedModelIndividual() override = default;
