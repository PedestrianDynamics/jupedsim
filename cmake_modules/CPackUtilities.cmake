function (cpack_write_deb_config)
  ...
  set(CPACK_DEBIAN_PACKAGE_DEPENDS "fmt, boost, spdlog, cli11, zlib" PARENT_SCOPE)
  set(CPACK_DEBIAN_PACKAGE_HOMEPAGE "http://jupedsim.org" PARENT_SCOPE)
  set(CPACK_DEBIAN_PACKAGE_SUGGESTS, "jpsvis, jpsreport, jpseditor" PARENT_SCOPE)
...
function (cpack_write_osx_config)
  ...
  message(STATUS "GEN: ${CPACK_GENERATOR}")
  set(CPACK_DMG_BACKGROUND_IMAGE  "${CMAKE_SOURCE_DIR}/jpscore/forms/JPScore.ico" PARENT_SCOPE)
  set(CPACK_DMG_VOLUME_NAME "${PROJECT_NAME}" PARENT_SCOPE)
  set(CPACK_SYSTEM_NAME "OSX" PARENT_SCOPE)
  set(CPACK_PACKAGE_ICON "${CMAKE_SOURCE_DIR}/jpscore/forms/JPScore.ico" PARENT_SCOPE)
...
function (cpack_write_config)
  ...
  set(CPACK_SOURCE_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}_${PROJECT_VERSION}" PARENT_SCOPE)
