...
[Generalized Centrifugal Force Model with lateral swaying][#Krausz]
is mostly identical to the GCFM Model, but instead of a variable semi-axis \\(b\\) of the ellipse simulating the pedestrian, pedestrians perform an oscillation perpendicular to their direction of motion.
