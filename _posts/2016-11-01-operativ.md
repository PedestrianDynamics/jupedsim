...
In summary the relevant section for this model (with default values based on [PED2012, p. 603–613](#Chraibi2014)) could look like:
...
Setting `ampA` and `ampB` to 0 disables lateral swaying. If not specified, the empirical values given in [Krausz][#Krausz2012] are used, that is:
...
[Chraibi2014]: https://doi.org/10.1007/978-3-319-02447-9_50 "Chraibi, M., Seyfried, A., & Schadschneider, A. (2014). Quantitative Validation of the Generalized Centrifugal Force Model. In Pedestrian and Evacuation Dynamics 2012 (S. 603–613). Cham: Springer International Publishing."
