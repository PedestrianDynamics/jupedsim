...
- [goals](#goals)
- [agents](#agents)
- [operational models](../../models/operativ/).
- [route choice models](../../models/routing).
...
-  The trajectory file 
   ```
    ...
    -   `xml-plain`: the default xml format. It can lead to large files. See section [xml-plain](#xml-plain).

    -   `plain`: simple text format. See section [plain-text](#plain-text).
...
-   `<geometry>geometry.xml</geometry>`
    ...
    to the actual location of the project file. See [specification](#geometry) of the geometry format.
...
- `trans_id`: unique id of that specific door as defined in the geometry file. See [geometry](#geometry).
...
- `router_id`: defines the route choice model to be used. See [documentation](../../models/router) of available routers.

- `age`: not yet used by the [operational](../../model/operativ) models.
...
- `agent_parameter_id`: choose a set of parameters for the [operational models](../../models/operativ/).
