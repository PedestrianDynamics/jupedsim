...
void VoronoiDiagramGenerator::generateVertexLinks()
{
     ...
     for(i = 0; i< count3counter; i++)
     {
          ...
          if(finalVertexLinks[count3vertices[i]].count > 2 || finalVertexLinks[count3vertices[i]].count < 0)
          {
               LOG<<"Error: finalVertexLinks[count3vertices[i]].count = "<<finalVertexLinks[count3vertices[i]].count;
               return;
          }
