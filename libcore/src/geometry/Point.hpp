 ...
 *
 * # Description
 * Basic 2-d vectorial structure to deal with 2-D points. This class provides interaction for two
 *points with each other and fullfills [boost/geometry object
 *model](http://www.boost.org/doc/libs/1_60_0/libs/geometry/doc/html/geometry/examples/example__adapting_a_legacy_geometry_object_model.html)
 * for a 2-d point.
 *
 *
 **/
