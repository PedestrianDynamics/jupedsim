...
/**
 * Calculates if a point (which is inside the subroom) is far enough from the walls, transitions,
 * crossings ( > radius of a person)
 * @param subroom
 * @param pt
 */
 ...
 * @param max_dis, after calling the function this will be the (distance*factor)^2 where distance is
 * the distance to the chosen vertex
