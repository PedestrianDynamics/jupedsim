...
{
    // Function was change fundamentaly.
    // At the moment the function checks, if the pedestrian is inside of any subroom.
    // This needs to be tested, since we are removing rooms sooner or later this needs to be changed again.
}
